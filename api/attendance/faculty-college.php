...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        if ($periodStart && $periodEnd) {
            $stmt = $pdo->prepare("SELECT * FROM attendance_faculty_college WHERE period_start = :start AND period_end = :end");
    ...
    case 'POST':
        ...
        $stmt = $pdo->prepare("SELECT id FROM attendance_faculty_college WHERE employee_id = :id AND period_start = :start AND period_end = :end");
